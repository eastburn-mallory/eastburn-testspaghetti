...
- Job 1 prints the provided input and produces an output
- Job 2 confirms that the environment secret is configured.
- Job 2 prints the output generated by Job 1.
- The secret value is never displayed in the logs.
